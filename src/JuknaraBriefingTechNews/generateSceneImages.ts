...
Style requirements:
- Futuristic cyberpunk illustration style
- Dark backgrounds with vibrant neon colors (cyan, pink, purple, electric blue)
- High contrast neon lighting with glowing edges
- Blade Runner inspired sci-fi atmosphere with holographic elements
