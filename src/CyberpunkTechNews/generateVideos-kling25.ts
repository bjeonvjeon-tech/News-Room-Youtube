...
/**
 * Kling v2.5 Turbo Pro - fal.ai API를 통한 비디오 생성
 *
 * 가격: 5초 = $0.35, 10초 = $0.70
 * 10개 씬 (5초씩) = $3.50
 */
...
async function generateVideo(prompt: string): Promise<string> {
  console.log(`   🎬 Generating with Kling v2.5 Turbo...`);
...
async function main() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("🎬 Kling v2.5 Turbo Pro 비디오 자동 생성");
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log(`📦 모델: ${MODEL}`);
  console.log(`⏱️  길이: ${VIDEO_DURATION}초`);
  console.log(`📐 비율: ${ASPECT_RATIO}`);
  console.log(`💰 예상 비용: $${0.35 * 10} (10개 씬)\n`);
  ...
  for (const scene of scenes) {
    ...
    try {
      ...
      const cost = VIDEO_DURATION === "5" ? 0.35 : 0.7;
      totalCost += cost;
      results.push({ scene: scene.id, status: "success", file: outputFile, cost });
